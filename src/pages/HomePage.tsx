...
{/* Hero Carousel */}
<section className="w-full relative overflow-hidden animate-slide-up">
  <div className="relative w-full aspect-video max-w-[1280px] mx-auto rounded-3xl shadow-2xl"> 
    <Swiper
        ...
        <SwiperSlide key={index}>
          ...
          >
            ...
            <div className="relative z-10 p-6 md:p-12 flex flex-col justify-center h-full max-w-2xl">
              <h2 className="text-2xl md:text-5xl font-black text-white drop-shadow-2xl mb-4 group-hover:scale-105 transition-transform duration-300">
                {slide.title}
              </h2>
              <p className="text-base md:text-xl text-white/90 drop-shadow-lg leading-relaxed">
                {slide.text}
              </p>
              <div className="mt-6">
